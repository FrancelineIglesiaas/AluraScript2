ERROS E STACKTRACE.js

const numero; 
 //error sintaxe//
//missing initializer in const declaration = falta inicializador na declaração da variavel const// é o valor que vamos inserir em const// const precisa ser delcarada//
//cltr + shift + c = copia terminal//

const numero = 1;
//missing ) after argument list = faltando ')' apos a lista de argumentos//

console.log(minhaVar);
//erro referencia - entre o condigo//
// minhaVar is not definied = minhaVar não esta definida// as variaveis devem ser definidas antes de ser comentadas e a const  definida e declarada.

//stacktrace - lista de arquivos no terminal - caminhos e arquivos internos //
//at object  - endereço - a linha - e o caracteres // 
